<?php
  ...
  class MovieDAO implements MovieDAOInterface {
    ...
    public function destroy($id) {
      // Primeiro, exclua as avaliações associadas ao filme
      $deleteReviewsStmt = $this->conn->prepare("DELETE FROM reviews WHERE movies_id = :id");
      $deleteReviewsStmt->bindParam(":id", $id);
      $deleteReviewsStmt->execute();
  
      // Agora, delete o filme da tabela movies
      $deleteMovieStmt = $this->conn->prepare("DELETE FROM movies WHERE id = :id");
      $deleteMovieStmt->bindParam(":id", $id);
